...
$string['pagebehavior_help'] = 'Escolha como a avaliação do modelo IA funciona: Pergunta e resposta, Contínua (conversa contínua), Turnos (navegação por turnos com árvore de conversa), ou Revisar conversa (upload de CSV e avaliação por conversa).';
...
$string['pagebehaviorreviewconversation'] = 'Revisar conversa';
$string['pagebehaviorreviewconversation_help'] = 'Envie um CSV com uma árvore de conversa já gerada. Os participantes navegarão pelas conversas importadas e avaliarão cada uma.';
$string['evaluationtitle'] = 'Título da avaliação';
$string['evaluationtitle_help'] = 'Título opcional exibido acima do bloco de perguntas de avaliação.';
$string['evaluationdescription'] = 'Descrição da avaliação';
$string['evaluationdescription_help'] = 'Texto opcional exibido abaixo do título da avaliação, acima das perguntas.';
$string['evaluationtitledefault'] = 'Avaliação';
$string['evaluationdescriptiondefault'] = 'Responda às perguntas abaixo.';
$string['save'] = 'Salvar';
...
$string['reviewconversationcsv'] = 'CSV da conversa para revisão';
$string['reviewconversationcsv_help'] = 'Envie um CSV exportado do histórico de conversa. Cabeçalhos esperados: Turn ID, Model ID, Role, Content, Timestamp, Message ID, Parent ID.';
$string['reviewdatasetstatus'] = 'Status do dataset';
$string['reviewdatasetready'] = 'Pronto';
$string['reviewdataseterror'] = 'Erro';
$string['reviewdatasetreplace'] = 'Substituir CSV';
$string['reviewconversationtitle'] = 'Revisar conversa';
$string['reviewnodatayet'] = 'Nenhum dataset de conversa disponível ainda.';
...
$string['reviewinvalidcsvheaders'] = 'Cabeçalhos CSV inválidos. Esperado: Turn ID, Model ID, Role, Content, Timestamp, Message ID, Parent ID.';
$string['reviewduplicateid'] = 'Message ID ausente ou duplicado no CSV: {$a}';
$string['reviewinvalidgraph'] = 'Grafo de conversa inválido (ciclo detectado).';
...
$string['notificationclose'] = 'Fechar';
$string['notificationinfo'] = 'Informação';
$string['notificationsuccess'] = 'Sucesso';
$string['notificationerror'] = 'Erro';
$string['notificationwarning'] = 'Aviso';
...
$string['maxqaquestions'] = 'Máximo de perguntas (P&R)';
$string['maxqaquestions_help'] = 'Número máximo de pares de pergunta e resposta permitidos. Ao atingir esse limite, o usuário não poderá adicionar novas perguntas. Deixe em branco para não definir máximo.';
$string['maxqaquestionsmustbegreaterthanminqaquestions'] = 'O máximo de perguntas (P&R) deve ser maior ou igual ao mínimo.';
$string['maxqaquestionsreached'] = 'Número máximo de perguntas atingido. Você não pode adicionar mais perguntas.';
...
$string['minqaquestions'] = 'Mínimo de perguntas (P&R)';
$string['minqaquestions_help'] = 'Número mínimo de pares de pergunta e resposta. Deixe em branco para não definir mínimo.';
$string['model'] = 'Model';
...
$string['branchcreated'] = 'Ramo criado com sucesso.';
$string['branchhelpertree'] = 'Clique em "Ramo" em qualquer turno para criar um novo caminho a partir desse ponto.';
$string['newconversation'] = 'Nova conversa';
$string['exportconversation'] = 'Exportar conversa';
$string['exportconversationdesc'] = 'Exporta a conversa atual para um arquivo CSV';
$string['startnewconversation'] = 'Clique no botão abaixo para iniciar uma nova conversa';
$string['createdirectbranch'] = 'Criar ramo direto';
...
$string['finalizeexperimentpage'] = 'Finalizar experimento';
$string['finalizeexperimentdescription'] = 'Revise suas respostas e finalize sua avaliação. Após finalizar, o experimento ficará somente leitura.';
$string['reviewandfinalizeexperiment'] = 'Revisar e finalizar experimento';
$string['viewfinalizationsummary'] = 'Ver resumo da finalização';
$string['finalizeexperimentmodaltitle'] = 'Finalizar experimento';
$string['questionsansweredlabel'] = 'Perguntas respondidas';
$string['questionsunansweredlabel'] = 'Perguntas não respondidas';
$string['requiredunansweredlabel'] = 'Obrigatórias não respondidas';
$string['finalizecertifycheckbox'] = 'Certifico que respondi todas as perguntas necessárias e quero encerrar minha avaliação agora.';
$string['cannotfinalizerequiredunanswered'] = 'Ainda há perguntas obrigatórias não respondidas e você não pode finalizar.';
$string['certificationrequired'] = 'Você precisa marcar a certificação antes de finalizar o experimento.';
$string['experimentfinalizedreadonly'] = 'Este experimento já foi finalizado e está em modo somente leitura.';
$string['experimentfinalizedsuccess'] = 'Experimento finalizado com sucesso.';
$string['experimentfinalizedstatus'] = 'Este experimento já foi finalizado.';
$string['finalizedatlabel'] = 'Finalizado em';
$string['experimentreadonlybanner'] = 'Este experimento foi finalizado e está em modo somente leitura.';
